...
<div class="col">
    ...
    <div class="card">
        ...
        <div class="card-block">
            @role('admin')
                <a href="{{ action('FileController@exportDecisionList', ['decision' => 1]) }}" class="btn btn-success">Download Accepted List ({{$accepted}})</a>
                <a href="{{ action('FileController@exportDecisionList', ['decision' => 0]) }}" class="btn btn-danger">Download Denied List ({{$denied}})</a>
                <hr/>
            @endrole
