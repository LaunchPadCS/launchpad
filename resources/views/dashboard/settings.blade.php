        ...
        <div class="card-block">      
            ...
            <form id="settingsForm">
                ...
                <div class="form-group">
                    ...
                    @role(['admin', 'mentor'])
                        <p class="form-text text-muted">Displayed on {{ env('APP_NAME') }} homepage. Recommended so others can learn about you, but not required.</p>
                    @endrole
                    @role(['mentee'])
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="inputInstagram" value="{{Auth::user()->instagram}}" name="instagram" placeholder="Instagram Username">
                    </div>
